...
assert normalize_record({"AgeFrom": "35", "AgeTo": "0"})["age_range"] == (35, 35)
assert normalize_record({"AgeFrom": "5", "AgeTo": "0"})["age_range"] == (5, 5)
assert normalize_record({"AgeFrom": "35", "AgeTo": "30"})["age_range"] == (35, 35)
assert normalize_record({"AgeFrom": "0", "AgeTo": "7"})["age_range"] == (7, 7)
assert normalize_record({"AgeFrom": "0", "AgeTo": "0"})["age_range"] is None
assert normalize_record({"AgeFrom": "abc", "AgeTo": "xyz"})["age_range"] is None

print("Edge-case age checks passed.")
